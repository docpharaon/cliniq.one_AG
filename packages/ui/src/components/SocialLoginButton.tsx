...
export function SocialLoginButton({
    ...
    const displayLabel = label || (isApple ? 'Sign in with Apple' : 'Sign in with Google');
    ...
    return (
        ...
        >
            ...
            <span style={isApple ? styles.appleLabel : styles.googleLabel}>{displayLabel}</span>
        </button>
    );
}
