// Base
export { CliniqIcon } from './CliniqIcon';
export type { CliniqIconProps } from './types';
...
// People
export { GenderMale, GenderFemale, GenderDiverse, Police } from './people';

// Content
export { ClipboardList, FileText, Mail, MessageSquare, BookOpen, Calendar, BarChart, Target, Bug, Lightbulb, Smartphone, Leaf, PartyPopper, Scroll, Cookie, Mailbox } from './content';
