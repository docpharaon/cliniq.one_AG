-- Migration: Update Global Guard with enhanced AI-driven violation detection
-- This updates the LIVE global guard prompt to use contextual AI detection
-- for gibberish, non-cooperation, refusal, and off-topic patterns.
