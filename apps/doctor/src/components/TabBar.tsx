...
import { typography, Home, ClipboardList, Calendar, User, useTheme } from '@cliniqone/ui';
...
export function TabBar() {
    ...
    const tabs: { path: string; label: string; Icon: (p: CliniqIconProps) => ReactNode; end?: boolean }[] = [
        ...
        { path: '/tabs/calendar',  label: t('doctor.calendar'),  Icon: Calendar },
        { path: '/tabs/profile',   label: t('doctor.myProfile'), Icon: User },
    ];
