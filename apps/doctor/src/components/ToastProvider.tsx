...
const TYPE_STYLES: Record<ToastType, { bg: string; border: string; icon: React.ReactNode; text: string }> = {
    success: { bg: '#ECFDF5', border: '#059669', icon: <CheckCircle size={16} color="#059669" />, text: '#065F46' },
    error:   { bg: '#FEF2F2', border: '#DC2626', icon: <XCircle size={16} color="#DC2626" />, text: '#991B1B' },
    warning: { bg: '#FFFBEB', border: '#D97706', icon: <AlertTriangle size={16} color="#D97706" />, text: '#92400E' },
    info:    { bg: '#F0FDFA', border: '#1A8A9E', icon: <Info size={16} color="#1A8A9E" />, text: '#134E4A' },
};
...
function ToastItem({ toast }: { toast: Toast }) {
    ...
    return (
        ...
        >
            <span style={{ display: 'flex', marginRight: 8 }}>{style.icon}</span>
