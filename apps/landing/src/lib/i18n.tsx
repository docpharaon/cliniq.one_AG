...
const translations: Record<string, Record<Locale, string>> = {
    ...
    'avail.sub': { en: 'We\'re actively onboarding testers. Register your interest and be the first to know when new platforms launch.', ar: 'نستقبل المختبرين حالياً. سجّل اهتمامك وكن أول من يعرف عند إطلاق منصات جديدة.' },
    ...
    'avail.ios_cta': { en: 'Notify Me', ar: 'نبّهني عند الإطلاق' },
    'avail.ios_email_ph': { en: 'your@email.com', ar: 'your@email.com' },
    'avail.ios_success': { en: "You're on the list! We'll email you when iOS testing opens.", ar: 'تم تسجيلك! بنبلّغك أول ما ينزل.' },
    ...
    'dl.warning': { en: 'You may need to enable "Install from Unknown Sources" in your Android settings. These are tester builds — not yet available on Google Play.', ar: 'ممكن تحتاج تفعّل "التثبيت من مصادر غير معروفة" في إعدادات الجوال. هذي نسخ تجريبية وما نزلت على Google Play بعد.' },
