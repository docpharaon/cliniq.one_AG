        ...
        <div className="min-h-screen bg-[#0A0E1A] text-[#F1F5F9]">
            <div className="max-w-3xl mx-auto px-6 py-20">
                ...
                <div className="prose prose-invert prose-sm max-w-none space-y-8 text-[#94A3B8] leading-relaxed">
                    <section>
                        <h2 className="text-xl font-bold text-[#F1F5F9] mb-3">1. AI in cliniq.one</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-[#F1F5F9] mb-3">2. What AI Does</h2>
                        <ul className="list-disc pl-6 space-y-2">
                            <li><strong className="text-[#F1F5F9]">Medical Intake Interview</strong> — An AI chatbot conducts a structured medical interview, gathering symptoms, medical history, medications, allergies, and review of systems.</li>
                            <li><strong className="text-[#F1F5F9]">Smart Specialty Routing</strong> — AI analyzes symptoms to recommend the appropriate medical specialty (or multiple specialties for complex cases).</li>
                            <li><strong className="text-[#F1F5F9]">Clinical Note Generation</strong> — AI structures the patient&apos;s responses into a professional clinical document for the reviewing physician.</li>
                            <li><strong className="text-[#F1F5F9]">Safety Verification</strong> — 19 AI-powered safety layers continuously check for drug interactions, allergy conflicts, dosage errors, and red-flag symptoms.</li>
                            <li><strong className="text-[#F1F5F9]">Medical Spelling &amp; Terminology</strong> — AI auto-corrects medical terms and drug names to ensure accuracy.</li>
                        </ul>
                    </section>

                    <section>
                        <h2 className="text-xl font-bold text-[#F1F5F9] mb-3">3. What AI Does NOT Do</h2>
                        <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-5 mt-3">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-[#F1F5F9] mb-3">4. AI Model Information</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-[#F1F5F9] mb-3">5. Human Oversight</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-[#F1F5F9] mb-3">6. Patient Data &amp; AI</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-[#F1F5F9] mb-3">7. Limitations</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-[#F1F5F9] mb-3">8. Contact</h2>
                        <p>For questions about our use of AI, contact us at <a href="mailto:admin@cliniq.one" className="text-[#2DD4BF] hover:underline">admin@cliniq.one</a>.</p>
                    </section>
                </div>
            </div>
        </div>
