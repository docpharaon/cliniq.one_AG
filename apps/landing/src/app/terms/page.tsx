        ...
        <div className="min-h-screen bg-white text-text-primary">
            <div className="max-w-3xl mx-auto px-6 py-20">
                ...
                <div className="prose prose-sm max-w-none space-y-8 text-text-secondary leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-navy mb-3">3. Medical Disclaimer</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-navy mb-3">4. Eligibility</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-navy mb-3">6. Privacy &amp; Data Handling</h2>
                        <p>cliniq.one follows a zero-storage philosophy. Medical data is processed in real-time session memory and automatically purged within 24 hours. For full details, see our <a href="/privacy" className="text-accent hover:underline">Privacy Policy</a>.</p>
                    </section>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-navy mb-3">8. Beta Testing Program</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-navy mb-3">9. Limitation of Liability</h2>
                    ...
                    <section>
                        ...
                        <p>For questions about these Terms, contact us at <a href="mailto:admin@cliniq.one" className="text-accent hover:underline">admin@cliniq.one</a>.</p>
                    </section>
                </div>
            </div>
        </div>
