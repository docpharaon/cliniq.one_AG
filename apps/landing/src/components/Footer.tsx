...
export default function Footer() {
    ...
    return (
        <footer className="bg-bg-secondary border-t border-border py-12 sm:py-16">
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid sm:grid-cols-3 gap-10 mb-12">
                    ...
                    <div>
                        <h4 className="text-sm font-semibold text-navy mb-4">{t('footer.platform')}</h4>
                        <div className="space-y-2.5">
                            <a href="#doctors" className="block text-sm text-text-muted hover:text-accent transition-colors">{t('nav.doctors')}</a>
                            ...
                            <a href="#tester-signup" className="block text-sm text-text-muted hover:text-accent transition-colors">{t('nav.consultation')}</a>
                        </div>
                    </div>

                    <div>
                        <h4 className="text-sm font-semibold text-navy mb-4">{t('footer.contact')}</h4>
                        <div className="space-y-2.5">
                        ...
                        <div className="mt-6">
                            <h4 className="text-sm font-semibold text-navy mb-3">{t('footer.markets')}</h4>
                            <div className="flex gap-2">
                                <span className="px-3 py-1 rounded-full text-xs bg-accent-faded text-accent font-medium border border-accent/10">{t('footer.ksa')}</span>
                                <span className="px-3 py-1 rounded-full text-xs bg-blue-faded text-blue font-medium border border-blue/10">{t('footer.uae')}</span>
                            </div>
                        </div>
                    </div>
                </div>
