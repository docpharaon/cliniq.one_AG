...
const managementGroups: { title: string; items: NavItem[] }[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'WA Subscriptions', href: '/dashboard/wa-subscriptions', icon: MessageSquare },
            { label: 'WA Sessions', href: '/dashboard/wa-sessions', icon: MessageCircle },
            { label: 'WA Bookings', href: '/dashboard/wa-bookings', icon: CalendarCheck },
            { label: 'WA Templates', href: '/dashboard/wa-templates', icon: MessageSquare },
            { label: 'WA Logs', href: '/dashboard/wa-notifications', icon: ListFilter },
