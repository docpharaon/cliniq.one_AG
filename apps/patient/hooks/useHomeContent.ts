...
// Hardcoded fallbacks — match the original static dashboard
    ...
    const fetchAll = useCallback(async () => {
        try {
            ...
            const [tipsRes, campaignsRes, settingsRes] = await Promise.all([
                ...
                // 2. Active campaigns (within schedule window)
                supabase
                    .from('campaigns')
            ...
            // Apply tips (fallback to defaults)
