        ...
        mutation.mutate(
            {
                ...
                aiSession: {
                    qaHistory: intake.qaHistory,
                    aiSummary: intake.aiSummary,
                    photos: intake.photos,
                    photoBodyLocations: intake.photoBodyLocations,
                    medicationVerifications: intake.medicationVerifications,
                    drugLabelAnalyses: intake.drugLabelAnalyses,
                },
